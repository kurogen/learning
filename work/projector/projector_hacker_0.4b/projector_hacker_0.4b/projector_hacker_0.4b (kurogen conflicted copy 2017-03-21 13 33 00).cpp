...
int main()
{
	...
	//ввод переменных
	int value_1, value_2;
	float w_size_scrn, h_size_scrn, w_res_scrn, h_res_scrn, w_size_px, h_size_px, ratio_scrn, area_scrn, distance_proj, w_ratio_proj, ratio_px;
	...
	for (;;)
	{
		...
		case 1:
			...
			w_ratio_proj = distance_proj / w_size_scrn;		// проекционное отношение объектива по ширине
			...
			cout << endl;
			cout << "Проекционное отношение объектива: " << w_ratio_proj << ":1" << endl;
		...
		case 2:
			...
			w_size_scrn = distance_proj / w_ratio_proj;
			h_size_scrn = w_size_scrn / (w_res_scrn / h_res_scrn);
		...
		case 3:
			...
			distance_proj = w_size_scrn * w_ratio_proj;
