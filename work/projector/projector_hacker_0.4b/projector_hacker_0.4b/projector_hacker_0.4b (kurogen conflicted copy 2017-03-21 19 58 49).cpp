...
int main()
{
	...
	int string;
	string value_1;
	string value_2; //переменные меню
	...
	float gain_scrn; //коэффициентом усиления (отражения) экрана
	...
	for (;;)
	{
		...
		cout << "4. Яркость изображения" << endl;
		cout << "5. Яркость проектора" << endl << endl;
		cin >> value_1;
		cout << endl;
		cout << "--------------------------------------------------------------" << endl;
		cout << endl;
